          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <p className="text-xl mb-4" style={{ color: '#888888' }}>
                Help children develop self-control and healthy screen time habits
              </p>
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3">
                ...
                <span style={{ color: '#171717' }}>Teaches self-control and patience</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-2 h-2 rounded-full" style={{ backgroundColor: '#5684C4' }}></div>
                <span style={{ color: '#171717' }}>Reduces screen time conflicts</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-2 h-2 rounded-full" style={{ backgroundColor: '#5684C4' }}></div>
                <span style={{ color: '#171717' }}>Builds healthy family routines</span>
              </div>
            </div>
            ...
            <div className="pt-4 border-t border-gray-200">
              <div className="text-sm space-y-2" style={{ color: '#888888' }}>
                <p>✓ Recommended by child psychologists</p>
                <p>✓ Helps establish family rules</p>
                <p>✓ Trusted by 25,000+ families</p>
              </div>
            </div>
          </div>
        </div>
