          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <p className="text-xl mb-4" style={{ color: '#888888' }}>
                Lock away screens and distractions for better sleep hygiene
              </p>
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3">
                ...
                <span style={{ color: '#171717' }}>Perfect for bedtime phone lockaway</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-2 h-2 rounded-full" style={{ backgroundColor: '#5684C4' }}></div>
                <span style={{ color: '#171717' }}>Silent operation for peaceful sleep</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-2 h-2 rounded-full" style={{ backgroundColor: '#5684C4' }}></div>
                <span style={{ color: '#171717' }}>Timer settings up to 8+ hours</span>
              </div>
            </div>
            ...
            <div className="pt-4 border-t border-gray-200">
              <div className="text-sm space-y-2" style={{ color: '#888888' }}>
                <p>✓ Recommended by sleep specialists</p>
                <p>✓ Helps establish bedtime routines</p>
                <p>✓ Trusted by 20,000+ better sleepers</p>
              </div>
            </div>
          </div>
        </div>
